...
class EndView(w.Window):
    def __init__(self, game_result):
        ...
        self.recOnceAgain = pygame.Rect(self.REC_ONCE_AGAIN_COORD[0], self.REC_ONCE_AGAIN_COORD[1], self.REC_WIDTH,
                                        self.REC_HEIGHT)
    ...
    def draw(self):
        ...
        x = self.REC_WIDTH / 2 - self.__text_play_again.getLength() / 2 + self.REC_ONCE_AGAIN_COORD[0]
        y = self.REC_HEIGHT / 2 - self.__text_play_again.getHeigth() / 2 + self.REC_ONCE_AGAIN_COORD[1]
        ...
        self.__text_result.draw(self.screen, (self.RESOLUTION[0] / 2 - self.__text_result.getLength() / 2, 80))
